...
I started playing this CTF and thought that I couldn't complete, but still tried. The url given was [https://07.levelupctf.com/radio](https://07.levelupctf.com/radio) and the description says we are an **Agent** in top-secret operation: Hack Another Day. The CTF had 7 flags in total.
